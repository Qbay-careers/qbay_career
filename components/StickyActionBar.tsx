  ...
  return (
    ...
    >
      <div className="bg-white/90 backdrop-blur-2xl border border-white/40 rounded-full p-1.5 shadow-2xl shadow-purple-900/10 flex gap-2 pointer-events-auto items-center">
        <a
          href="/contact"
          className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-full bg-white px-3 py-2.5 text-xs font-bold text-[#4B2C83] border border-purple-100 hover:bg-purple-50 transition-all font-sans"
        >
        ...
        <a
          ...
          className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-full bg-[#25D366] px-3 py-2.5 text-xs font-bold text-white hover:bg-[#128C7E] shadow-lg shadow-green-500/20 transition-all hover:scale-[1.02] font-sans"
        >
          <span className="inline-flex h-4 w-4 items-center justify-center">
