...
const mapVideoUrls = (items: any[], quality: 'hqdefault' | 'maxresdefault' = 'hqdefault') => {
  ...
  return items
    .map((item) => {
      ...
      const id = match?.[1];
      if (!id) return null;
      return { id, url, thumbnail: `https://i.ytimg.com/vi/${id}/${quality}.jpg`, flag };
    })
      ...
      <section id="client-love" className="relative bg-white py-10 scroll-mt-24 overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-12">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl sm:text-5xl lg:text-6xl font-extrabold text-[#2D1B4D] tracking-tight mb-4" dangerouslySetInnerHTML={{ __html: clientLoveTitle }} />
              ...
              <div className="flex gap-6 lg:gap-8 animate-hero-scroll hover:[animation-play-state:paused] w-max px-4">
                {[...testimonialShortsData, ...testimonialShortsData].map((video: any, idx: number) => (
                  ...
                  >
                    ...
                    />
                    {video.flag && (
                      <div className="absolute top-4 right-4 z-10 w-12 h-8 rounded-md overflow-hidden shadow-lg transition-transform duration-300 group-hover:scale-110">
