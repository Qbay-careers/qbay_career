                  ...
                  <div className="relative bg-white rounded-[2rem] border border-white/10 p-8 shadow-2xl">
                    <div className="flex flex-col items-center text-center space-y-6">
                      ...
                      <a
                        ...
                        className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-[#25D366] px-8 py-5 text-sm font-bold text-white transition-all hover:bg-[#128C7E] hover:scale-[1.02] active:scale-[0.98] shadow-xl shadow-green-500/20"
                      >
                        ...
                        <span>{consultationData?.ctaLabel === 'Book your free consultancy' ? 'Whatsapp Now' : (consultationData?.ctaLabel || 'Whatsapp Now')}</span>
                      </a>
