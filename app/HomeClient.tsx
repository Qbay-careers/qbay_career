...
export default function HomeClient({ initialData }: { initialData: any }) {
  ...
  const founderData = {
    ...
    linkedin: "https://www.linkedin.com/in/fazil-karatt/",
    instagram: "https://www.instagram.com/fazil_karat/"
  };
       ...
       <section id="client-love" className="relative bg-white py-10 sm:py-12 lg:py-14 scroll-mt-24 overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-20">
            <h2 className="text-2xl sm:text-5xl lg:text-6xl font-extrabold text-[#2D1B4D] tracking-tight mb-6" dangerouslySetInnerHTML={{ __html: clientLoveTitle }}>
            </h2>
            <p className="text-sm sm:text-xl text-slate-600 leading-relaxed font-medium">
              ...
              <div className="flex flex-col items-center gap-6 pt-4 w-full">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 w-full sm:w-auto">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center gap-3 w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-3.5 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 hover:bg-[#0077b5] hover:border-[#0077b5] transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_rgba(0,119,181,0.4)]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center gap-3 w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-3.5 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 hover:bg-gradient-to-r hover:from-[#E4405F] hover:to-[#fd1d1d] hover:border-[#E4405F] transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_rgba(228,64,95,0.4)]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center gap-3 w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-3.5 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 hover:bg-[#25D366] hover:border-[#25D366] transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_30px_rgba(37,211,102,0.4)]"
                  >
