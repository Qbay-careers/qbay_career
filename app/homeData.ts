export const defaultFrameworkPhases = [
  {
    number: '01',
    title: 'Partnership',
...
export const defaultTrustpilotReviews = [
...
export const defaultNegativeReviews = [
  { 
    name: 'James', 
